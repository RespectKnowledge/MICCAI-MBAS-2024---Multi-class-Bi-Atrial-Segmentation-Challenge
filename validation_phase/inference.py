...
def main():
    ...
    resources_dir = '/opt/app/resources'  # Replace with your actual path
    ...
    predictor.initialize_from_trained_model_folder(
        join(resources_dir, 'nnUNet_results/Dataset220_MBAS/nnUNetTrainer__nnUNetPlans__3d_fullres'),
        use_folds=('all',),
        checkpoint_name='checkpoint_final.pth',
    )
    print('validation and parameters are running')
